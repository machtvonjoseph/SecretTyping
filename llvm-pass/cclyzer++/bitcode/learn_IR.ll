; ModuleID = 'learn_IR.cpp'
source_filename = "learn_IR.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_learn_IR.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_learn_IR.cpp() #0 section ".text.startup" {
