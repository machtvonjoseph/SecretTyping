...
invoke.cont:                                      ; preds = %entry
  ...
  call void @_ZN4numaI9singleintLi3E13NumaAllocatorvE3putEi(ptr noundef nonnull align 8 dereferenceable(16) %i, i32 noundef 10)
  %i1 = load ptr, ptr %v, align 8
  %call1 = call noundef i32 @_ZN4numaI9singleintLi3E13NumaAllocatorvE3getEv(ptr noundef nonnull align 8 dereferenceable(16) %i1)
...
entry:
  ...
  %call = call noundef ptr @_ZN13NumaAllocatorI9singleintLi3EE8allocateEm(ptr noundef nonnull align 1 dereferenceable(1) %alloc, i64 noundef %i)
  ret ptr %call
}
...
entry:
  ...
  %i = load i32, ptr %val.addr, align 4
