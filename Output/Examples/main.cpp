	...
	if(DS_name == "stack"){
		...
		for(int i=0; i < num_threads/2; i++){
			...
			if(thread_config == "numa"){
				...
				numa_thread0[i] = new thread_numa<0>(BinarySearchTest, tid, duration, i%2, num_DS/2, num_threads/2);
			}
		}
		for(int i=0; i < num_threads/2; i++){
			int node = 1;
			...
			if(thread_config == "numa"){
				...
				numa_thread1[i] = new thread_numa<1>(BinarySearchTest, tid, duration, i%2, num_DS/2, num_threads/2);
			}
		}
		...
		for(int i=0; i < num_threads/2; i++){
			...
			if(thread_config == "numa"){
				...
				numa_thread0[i] = new thread_numa<0>(LinkedListTest, tid, duration, i%2, num_DS/2, num_threads);
			}
		}
		for(int i=0; i < num_threads/2; i++){
			int node = 1;
			...
			if(thread_config == "numa"){
				...
				numa_thread1[i] = new thread_numa<1>(LinkedListTest, tid, duration, i%2, num_DS/2, num_threads);
			}
		}
