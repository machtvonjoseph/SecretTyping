; ModuleID = './input/numaed_vector.cpp'
source_filename = "./input/numaed_vector.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_numaed_vector.cpp, i8* null }]
...
invoke.cont:                                      ; preds = %if.then
  call void @__cxa_throw(i8* %exception, i8* bitcast (i8** @_ZTISt13runtime_error to i8*), i8* bitcast (void (%"class.std::runtime_error"*)* @_ZNSt13runtime_errorD1Ev to i8*)) #12
  unreachable
...
invoke.cont3:                                     ; preds = %invoke.cont
  ...
  %call4 = call noalias noundef nonnull i8* @_Znwm(i64 noundef 8) #13
  %2 = bitcast i8* %call4 to %class.MyVector*
  invoke void @_ZN8MyVectorC2Eii(%class.MyVector* noundef nonnull align 8 dereferenceable(8) %2, i32 noundef 10, i32 noundef 3)
          to label %invoke.cont6 unwind label %lpad5

invoke.cont6:                                     ; preds = %invoke.cont3
  store %class.MyVector* %2, %class.MyVector** %v3, align 8
  ret i32 0
...
lpad5:                                            ; preds = %invoke.cont3
  ...
  call void @_ZdlPv(i8* noundef %call4) #14
  br label %eh.resume
...
entry:
  ...
  %alias = alloca i32*, align 8
  %alias2 = alloca i32*, align 8
  ...
  %call = call noundef nonnull align 8 dereferenceable(8) i32** @_ZN4numaIPiLi3E13NumaAllocatorvEcvRS0_Ev(%class.numa.1* noundef nonnull align 8 dereferenceable(8) %my_data2)
  %0 = load i32*, i32** %call, align 8
  store i32* %0, i32** %alias, align 8
  ...
  %1 = load i32*, i32** %call4, align 8
  store i32* %1, i32** %alias2, align 8
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZN8MyVectorC2Eii(%class.MyVector* noundef nonnull align 8 dereferenceable(8) %this, i32 noundef %sz, i32 noundef %val) unnamed_addr #6 comdat align 2 {
entry:
  ...
  %call = call noalias noundef nonnull i8* @_Znam(i64 noundef %4) #13
  %5 = bitcast i8* %call to i32*
  %my_data = getelementptr inbounds %class.MyVector, %class.MyVector* %this1, i32 0, i32 0
  store i32* %5, i32** %my_data, align 8
  %my_data2 = getelementptr inbounds %class.MyVector, %class.MyVector* %this1, i32 0, i32 0
  %6 = load i32*, i32** %my_data2, align 8
  store i32* %6, i32** %alias, align 8
  %my_data3 = getelementptr inbounds %class.MyVector, %class.MyVector* %this1, i32 0, i32 0
  %7 = load i32*, i32** %my_data3, align 8
  store i32* %7, i32** %alias2, align 8
  ret void
}
...
define linkonce_odr dso_local void @_ZN13NumaAllocatorIiLi3EEC2Ev(%class.NumaAllocator* noundef nonnull align 1 dereferenceable(1) %this) unnamed_addr #10 comdat align 2 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void @__cxa_throw(i8* %exception, i8* bitcast (i8** @_ZTISt9bad_alloc to i8*), i8* bitcast (void (%"class.std::bad_alloc"*)* @_ZNSt9bad_allocD1Ev to i8*)) #12
  unreachable
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt9bad_allocC2Ev(%"class.std::bad_alloc"* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #10 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt9exceptionC2Ev(%"class.std::exception"* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #10 comdat align 2 {
entry:
...
define linkonce_odr dso_local noundef nonnull align 8 dereferenceable(8) i32** @_ZN4numaIPiLi3E13NumaAllocatorvEcvRS0_Ev(%class.numa.1* noundef nonnull align 8 dereferenceable(8) %this) #11 comdat align 2 {
entry:
  %this.addr = alloca %class.numa.1*, align 8
  store %class.numa.1* %this, %class.numa.1** %this.addr, align 8
  %this1 = load %class.numa.1*, %class.numa.1** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN13NumaAllocatorI8MyVectorLi3EEC2Ev(%class.NumaAllocator.2* noundef nonnull align 1 dereferenceable(1) %this) unnamed_addr #10 comdat align 2 {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_numaed_vector.cpp() #0 section ".text.startup" {
entry:
