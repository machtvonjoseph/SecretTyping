...
case "$1" in
  DS)
    ...
    # For example: ls -l
    ./bin/clang-tool ../input/Data-Structures/Examples/main.cpp ../input/Data-Structures/Examples/TestSuite.cpp -- -I ../input/Data-Structures/Node/include/ -I ../input/Data-Structures/Stack/include/  -I../numaLib/ -I/usr/local/lib/clang/20/include/ -lnuma
    ;;
  dummy)
    echo "Running dummy"
