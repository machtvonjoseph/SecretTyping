...
case "$1" in
  ...
  Exprs)
    ...
    ./build/bin/clang-tool  --cast output/Exprs/Examples/main.cpp output/Exprs/Examples/TestSuite.cpp -- -I output/Exprs/Node/include/ -I output/Exprs/Stack/include/ -I output/Exprs/Queue/include/ -I output/Exprs/BinarySearch/include/  -I output/Exprs/LinkedList/include -I../numaLib/ -I/usr/local/lib/clang/20/include/ -lnuma
    ;;
  *)
